"""
Calculate the mean and stderr of the signed relative error of dielectric.
"""
...
((pred["corrected_dielectric"] - pred["expt_dielectric"]) / pred["expt_dielectric"]).mean()
((pred["dielectric"] - pred["expt_dielectric"]) / pred["expt_dielectric"]).mean()

((pred["corrected_dielectric"] - pred["expt_dielectric"]) / pred["expt_dielectric"]).std() / sqrt(len(xerr))
((pred["dielectric"] - pred["expt_dielectric"]) / pred["expt_dielectric"]).std() / sqrt(len(xerr))
