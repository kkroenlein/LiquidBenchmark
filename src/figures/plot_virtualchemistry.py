...
plt.draw()
savefig("./manuscript/figures/dielectric_virtual_chemistry_gaff_nocorr.pdf", bbox_inches="tight")
...
plt.gca().set_aspect('equal', adjustable='box')
plt.draw()
savefig("./manuscript/figures/dielectric_virtual_chemistry_gaff.pdf", bbox_inches="tight")
...
plt.gca().set_aspect('equal', adjustable='box')
plt.draw()
savefig("./manuscript/figures/dielectric_virtual_chemistry_opls_nocorr.pdf", bbox_inches="tight")
...
plt.gca().set_aspect('equal', adjustable='box')
plt.draw()
savefig("./manuscript/figures/dielectric_virtual_chemistry_opls.pdf", bbox_inches="tight")
