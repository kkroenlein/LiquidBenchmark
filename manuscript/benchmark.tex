...
Statistical uncertainties were computed as described above for automatic analysis of production simulations.
...
\end{eqnarray}
{\color{red}[JDC: Describe how statistical errors were computed.]}
