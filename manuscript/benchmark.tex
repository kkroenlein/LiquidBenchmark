...
{\color{red}[JDC: Should we shorten this to just ``A snapshot of the ThermoML Archive'' since there is now a way to retrieve up-to-date snapshots that is not necessarily through tarballs?  Also, should we mention here that this tool is available for other labs to perform their own retrieval?]}
...
Using this adaptive protocol, we found starting trajectory lengths of $12000$ $(8000, 16000)$ frames (250 fs each), discarded regions of $28$  $(0, 460)$ frames, and statistical inefficiencies of $20$ $(15, 28)$; reported numbers indicate (median, (25\% quartile, 75\% quartile)).  
{\color{red}[JDC: By ``frames'', is this instantaneous densities or configuration snapshots?]}
...
in the case of water, the empirical atomic polarizability model predicts a dielectric correction {\color{red}[JDC: Correction to $\epsilon$ or $1/\epsilon$?]} of 0.52, while 0.79 was used for the TIP4P-Ew model.  
Averaging all liquids in the present work leads to polarizability corrections to the static dielectric of $0.74 \pm 0.08$. {\color{red}[JDC: I don't understand the previous sentence.  Do you mean this is the average dielectric correction over all liquids?  Or maybe more clearly phrased as ``averaging this dielectric correction over all liquids gives an average correction of XXX''?]}
