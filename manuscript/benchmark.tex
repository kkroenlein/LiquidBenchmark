...
A USGS case study examining reported literature values of the aqueous solubility and octanol-water partition coefficients for DDT and its persistent metabolite DDE provide incredible insight into the potential issues associated with compiling literature values for physicochemical properties of molecules of lesser importance for environmental and human health~\cite{usgs-ddt-report}.
{\color{red}[JDC: More.]}
...
{\color{red}[JDC: I feel like we should also give pointers to the various other domain-specific tools, like OpenMM, openmoltools, and MDTraj.]}
...
{\color{red}[JDC: Bas has a nice way of auto-formatting numbers like in these tables.]}
