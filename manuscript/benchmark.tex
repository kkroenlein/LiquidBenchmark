...
Although detailed comparison of polarizable electrostatic models is outside the scope of the present work, the success of the simple empirical model (Eq. \ref{eq:sales}) suggests that simple polarizability models may be worth considering, particularly when simulating low dielectric liquids.  
