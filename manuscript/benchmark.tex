...
OpenMM simulations were performed using the AMBER prmtop and inpcrd files.  
Simulation code used libraries gaff2xml~0.7, OpenMM~6.3~\cite{eastman2012openmm}, and MDTraj~1.3~\cite{mcgibbon2014mdtraj}.  
The follow code can be used to install the necessary prerequisites:

%\begin{lstlisting}
conda config --add channels http://conda.binstar.org/omnia

conda install "gaff2xml>=0.7" "pymbar>=2.1" "mdtraj>=1.3" "openmm>=6.3" packmol
%\end{lstlisting}
...
The burn-in period of the production simulation was automatically selected using pymbar and discarded.  
