...
This approach is essentially the same as the fixed-width procedure described in \cite{brooks2011handbook} eq. 7.12, with $n^*$ equal to 1 ns and the $n^{-1}$ term ignored because $n \approx 1000$.  
